...
import {
  ...
  type CapabilityAgentsConfig,
  type CapabilityConfig,
  type CapabilityMcpConfig,
  type CapabilityMcpServerConfig,
  type LoadedSharedConfig,
  type ModelSelection,
  type ParsedModelRef,
  type SharedConfig,
  type SharedConfigError,
  type SharedConfigSourceMap,
  type SharedConfigWarning,
} from "./contracts.js";
import {
  configLayerResolutionOrder,
  existingConfigCandidatePaths,
  isRecord,
  readConfigFile,
  type ConfigLayerLabel,
} from "./file-io.js";
import {
  booleanSchema,
  integerArray,
...
/** Merge write guardrails conservatively across config layers. */
