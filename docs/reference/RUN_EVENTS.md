...
| Workflow runtime                  | `workflow.started`, `workflow.node.started`, `workflow.node.completed`, `workflow.interrupted`, `workflow.completed`, `workflow.failed`, `workflow.cancelled`                 | Show projection-run state, node verdicts, and terminal workflow status            |
