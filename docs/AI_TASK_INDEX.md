...
Read the linked entry file first, then the linked docs, then make the change. Do not invent extension points that are not listed below; if a task does not appear here, fall back to `docs/EXTENSION_INTERFACES.md` and `docs/HARNESS_COMPONENT_MODEL.md`.
...
- **Must read**: `docs/STATE_AND_TRACE_MODEL.md`, `docs/EXTENSION_INTERFACES.md`, `docs/PROTOCOL.md` (file trace section), `docs/HARNESS_COMPONENT_MODEL.md`
...
- **Must read**: `docs/PROVIDER_EDGE.md`, `docs/PROTOCOL.md` (`model.requested` / `model.completed` payloads), `docs/HARNESS_PRINCIPLES.md` "Provider Adapters Live At The Edge"
...
- **Must read**: `docs/PROVIDER_EDGE.md`
...
- **Must read**: `docs/STREAMING_LOOP_REQUIREMENTS.md`, `docs/PROTOCOL.md` (streaming events)
...
- **Must read**: `docs/EXTENSION_INTERFACES.md` (Tool Extensions), `docs/CUSTOM_TOOL_EXAMPLE.md`, `docs/PROTOCOL.md` (tool section)
...
- **Must read**: `docs/CONTEXT_PLANE.md`, `docs/EXTENSION_INTERFACES.md` (Context Extensions)
- **Must update on change**: no schema change for items; if introducing a new `metadata.layer` value, document it in `docs/CONTEXT_PLANE.md`
...
- **Must read**: `docs/PROTOCOL.md` (event envelope), `docs/TRACE_EXTENSION_EVENTS.md`
...
- **Must read**: `docs/PROTOCOL.md` (trace levels), `docs/TRACE_EXTENSION_EVENTS.md`, `docs/HARNESS_PRINCIPLES.md` ("Trace Is The Primary Interface")
...
- **Must read**: `docs/adr/0008-span-correlation-and-trace-sinks.md`, `docs/PROTOCOL.md` ("Span Correlation" section)
...
- **Must read**: `docs/STATE_AND_TRACE_MODEL.md`, ADR `0006-jsonl-traces-with-tiered-detail.md` (why events are facts, not span trees), ADR `0008-span-correlation-and-trace-sinks.md` (how to pair start/end via `spanId`)
- **Must update on change**: nothing in `schemas/` — sinks consume the existing envelope. New packages should be added to `docs/EXTENSION_RELEASE_CHECKLIST.md`.
...
- **Must read**: `docs/EXTENSION_INTERFACES.md` (Approval Extensions), `docs/HARNESS_PRINCIPLES.md` ("Model Proposes, Harness Disposes"), ADR `0004-approval-gated-workspace-writes.md`
...
- **Must read**: `docs/EXTENSION_INTERFACES.md` (Policy Extensions), `docs/SKILL_MCP_AGENT_CAPABILITY_MODEL.md`
...
- **Must read**: `docs/HARNESS_PRINCIPLES.md` ("Context Is A Budget"), `docs/PROTOCOL.md` (compaction events)
...
- **Must read**: `docs/HARNESS_PRINCIPLES.md` ("Failures Should Become Future Constraints")
...
- **Must read**: `docs/PROTOCOL.md` (artifact section), `docs/HARNESS_PRINCIPLES.md` ("Context Is A Budget")
- **Must update on change**: extend `Artifact` discriminant in `types.ts`; document the new kind in `docs/PROTOCOL.md`
...
- **Must read**: `docs/STATE_AND_TRACE_MODEL.md`, `docs/HARNESS_COMPONENT_MODEL.md`, `docs/PROTOCOL.md` (session events)
...
- **Must read**: `docs/ENVIRONMENT.md`, `docs/HARNESS_PRINCIPLES.md`, `docs/HARNESS_COMPONENT_MODEL.md`
...
- **Must read**: `docs/PROTOCOL.md` (file trace section), ADR `0006-jsonl-traces-with-tiered-detail.md`
...
- **Must read**: ADR / `docs/PROTOCOL.md` (session events)
...
- **Must read**: `docs/CONTEXT_PLANE.md` ("Prompt-Cache Invariant", "Section Cache Policy And Stability")
